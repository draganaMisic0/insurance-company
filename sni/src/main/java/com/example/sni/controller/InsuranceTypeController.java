...
public class InsuranceTypeController {
    ...
    public List<InsuranceType> getAll() {
        return insuranceTypeService.getAll().stream().map(it ->
                        new InsuranceType(it.getId(), it.getName(), it.getDuration(), it.getPrice())).
    ...
    public InsuranceType create(@RequestBody InsuranceType it) {
        ...
        return new InsuranceType(saved.getId(), saved.getName(), it.getDuration(), it.getPrice());
    }
    @GetMapping("/{id}")
    public InsuranceType getById(@PathVariable Integer id) {
        ...
        if (insuranceTypeEntity.isPresent()) {
            ...
            return new InsuranceType(it.getId(), it.getName(), it.getDuration(), it.getPrice());
        } else {
